package com.example.app_bd_1.db
import android.content.ContentValues
import android.content.Context
import android.database.Cursor
import android.database.sqlite.SQLiteDatabase
import android.database.sqlite.SQLiteOpenHelper
import com.example.app_bd_1.model.CourseModel.CourseModel
...
class DBHandler // creating a constructor for our database handler.
    ...
    fun addNewCourse(
        ...
        values.put(Telefone_COL, courseTelefone)
        values.put(Celular_COL, courseCelular)
    ...
    companion object {
        ...
        private const val TABLE_NAME = "APP1"
